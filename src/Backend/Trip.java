...
public class Trip {
    ...
    public void addToDataBase(){
        try {
            // Write in the database using comma separated format.
            FileWriter writer = new FileWriter("Trip_Database.txt", true);
            // Make new line before each trip.
            writer.write(System.lineSeparator());
            // Write the data in csv.
            writer.write(this.preprocessingData());
            writer.close();
        } catch (IOException e) {
